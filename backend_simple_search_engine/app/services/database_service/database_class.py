from backend_IR.app.services.database_service.models.trectot_class import TrecTotDocument
from backend_IR.app.services.database_service.models.webis_touche_class import WebisToucheDocument
